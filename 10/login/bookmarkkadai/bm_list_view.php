 ...
 <li>
  <div class="jumbotron">
    ...
    <dd><input type="text" name="name" class="box" value="<?=$res["Book_name"]?>"></dd>
     <dt>書籍URL</dt>
     <dd><input type="text" name="URL" class="box" value="<?=$res["Book_URL"]?>"></dd>
     <dt>書籍コメント</dt><dd><textArea name="kansou" rows="4" cols="40" class="box" id="editor1"><?=$res["kansou"]?></textArea></dd>
    <dt>画像</dt><dd><?php if($res["upfile"]!=""){ ?>
	                    <img src="<?=$res["upfile"]?>">
	                    <?php }?>
     </dd>
